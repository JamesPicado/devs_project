...
export default function Navbar() {
  ...
  return (
    <div
      className="fixed left-0 right-0 top-4 flex justify-center px-4 z-[999]"
      ref={navRef}
    >
      <div className="w-full max-w-5xl rounded-full border border-white/10 bg-[var(--background)] backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.5)] px-4 lg:px-8 py-3 flex items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="hidden lg:block text-sm tracking-[0.35em] text-[var(--foreground)]/70 uppercase">
            Tech Lab Solutions
          </span>
        </div>
        ...
        <nav className="hidden lg:flex items-center gap-6 text-[15px]">
          ...
          <button
            ...
            className="text-xs font-medium tracking-[0.16em] text-[#168cff]"
        ...
        <div className="lg:hidden flex items-center gap-3">
          <button
            onClick={() => setLanguage(language === "en" ? "es" : "en")}
            className="text-xs font-medium tracking-[0.12em] text-[#168cff]"
          >
            {language === "en" ? "ES" : "EN"}
          </button>
          <button
          ...
          {navOpen && (
            ...
            >
              ...
              <div className="pt-1 border-t border-white/10">
                <p className="text-xs uppercase tracking-[0.25em] text-[var(--foreground)]/60 mb-3">
